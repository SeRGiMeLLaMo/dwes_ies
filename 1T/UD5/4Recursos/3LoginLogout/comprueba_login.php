...
try{
        ...
        $sql= "SELECT * FROM ud5_usuarios_pass where user= :login and pass= :password";
        ...
        // Necesitamos un usuario en nuestra tabla:  insert intoud5__usuarios_pass(id, password, usuarios); 
